...
<title>Cargar evidencia - PraxiLab</title>
</head>
<body>
	...
	<form method="post" enctype="multipart/form-data" role="form" action="{{url('createEvidencia/'.$practicaEvidencia->id_historial_practica.'')}}"> 
